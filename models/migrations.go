...
var MigrationWhere = struct {
	...
	Version: whereHelperint64{field: "\"migrations\".\"version\""},
	Dirty:   whereHelperbool{field: "\"migrations\".\"dirty\""},
}
...
var (
	migrationAllColumns            = []string{"version", "dirty"}
	migrationColumnsWithoutDefault = []string{"version", "dirty"}
	migrationColumnsWithDefault    = []string{}
	migrationPrimaryKeyColumns     = []string{"version"}
)
...
func FindMigration(ctx context.Context, exec boil.ContextExecutor, version int64, selectCols ...string) (*Migration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"migrations\" where \"version\"=$1", sel,
	)
...
func (o *Migration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"migrations\" WHERE \"version\"=$1"
...
func (o *Migration) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindMigration(ctx, exec, o.Version)
	if err != nil {
		return err
	}
...
func MigrationExists(ctx context.Context, exec boil.ContextExecutor, version int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"migrations\" where \"version\"=$1 limit 1)"
